...
** Script: tiempo máximo de ejecución (en minutos) *: tiempo máximo para ejecutar un script por defecto
* *Tiempo de espera de Jeecron*: Tiempo de espera del cron principal (entre 1 y 59 segundos)
** Tiempo para dormir los Demonios*: Indica el tiempo entre 2 ciclos para dormir un demonio por defecto
