...
= Interaktionen - Grundlagen

Das Interaktionssystem in Jeedom ermöglicht Aktionen von Text- oder Sprachbefehl.
...
Zum zugiff auf die Interaktions Seite, müssen sie auf Werkzeuge -> Interaktionen gehen : 
...
"\#profile#" => Name der Person, die tatsächliche die Ausführung gestartet hat (unter Umständen nicht verfügbar)
Beispiel : "\#valeur# \#unite#"
